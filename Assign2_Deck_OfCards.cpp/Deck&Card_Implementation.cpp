 ...
 * NOTE: All private members in both classes will be enclose in double
 *       quotes " "
 *******************************************************************************/
	/***************************************************************************
	 * Card (constructor)
	 ...
	 ***************************************************************************/
	void Deck::PrintShuffledDeck() const
	{
		//Begin For
		for(int index = 0; index < SIZE; index++)
		{
	 ...
	 * This method prints the "perfectShuffle" array
	 ***************************************************************************/
	void Deck::PrintFinalDeck() const
	{
		//Begin For
		for(int index = 0; index < SIZE; index++)
		{
	 ...
	 * standard deck of cards (read furthur for more details)
	 ***************************************************************************/
	void Deck::	InitializeDeck()
	{
		...
		for(index = 0; index < 4; index++)
		{
			...
			switch(index)
			{
				...
				break;
				case 1: //Initializes cards 12-24
						suit = "Spades";
						//Begin For
						for(innerIndex = 1; innerIndex <= 13; innerIndex++)
						{
				...
				break;
				case 2: //Initializes cards 25-38
						suit = "Hearts";
						//Begin For
						for(innerIndex = 1; innerIndex <= 13; innerIndex++)
						{
				...
				break;
				case 3: //Initializes cards 39-51
						suit = "Diamonds";
						//Begin For
						for(innerIndex = 1; innerIndex <= 13; innerIndex++)
						{
	 ...
	 * RETURNS: None
	 ***************************************************************************/
	bool Deck::CheckFinalDeck() const
	{
		//D E C L A R A T I O N S
