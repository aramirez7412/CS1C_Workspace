...
MathStudent::~MathStudent()
{
	...
	cout << "\nVirtual Destructor Math Student called! #" << GetObjectCount();
}
...
void MathStudent::SetNewDay(int newDay)
{
	graduationDate.SetDay(newDay);
}
void MathStudent::SetNewMonth(int newMonth)
{
	graduationDate.SetMonth(newMonth);
}
void MathStudent::SetNewYear(int newYear)
{
	graduationDate.SetYear(newYear);
}
void MathStudent::SetAllDate(int newMonth, int newDay, int newYear)
{
	SetNewDay(newDay);
...
int MathStudent::GetMonth() const
{
	return graduationDate.GetMonth();
}

int MathStudent::GetYear() const
{
	return graduationDate.GetYear();
}

int MathStudent::GetDay() const
{
	return graduationDate.GetDay();
}
